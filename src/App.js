...
<div className='overlay px-5'>
  <h1 className='text-4xl font-bold text-white text-center mb-4 capitalize lg:text-6xl'>Viewing News about {term}</h1>
...
{/* className='text-center mt-20 font-bold text-6xl' */}
  <Circles	  
    height = "80"
    width = "1400"
    radius = "9"
